"""Regression checks for the copper-parse-sql-flow casebook."""
...
from casebook.harness import assert_expected, copper_parse_sql_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_parse_sql_flow_summary(), assert_expected())
